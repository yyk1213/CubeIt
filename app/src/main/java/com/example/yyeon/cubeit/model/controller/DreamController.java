...
public class DreamController implements Controller<Dream> {
  ...
  private RealmList<RealmString> getSubTargetItems() {
    ...
    userTargetItems.add(new RealmString("Luck"));
    userTargetItems.add(new RealmString("Leadership"));
    userTargetItems.add(new RealmString("Software Development"));
    userTargetItems.add(new RealmString("Personality"));
    userTargetItems.add(new RealmString("Self-Control"));
    userTargetItems.add(new RealmString("Executive Abilities"));
    userTargetItems.add(new RealmString("Trend Analyzing Abilities"));
    userTargetItems.add(new RealmString("Attractiveness"));
